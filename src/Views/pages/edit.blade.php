            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form id="form_validation" method="post" class="card">
                    <div class="header">
                        <h2>
                            New page creating
                            <button type="submit" class="btn btn-lg bg-green waves-effect pull-right">Save page</button>
                        </h2>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <label for="tinymce" class="form-label">Text</label>
                                     <textarea name="text" id="tinymce">{{ $page->text }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input id="uri" value="{{ $page->uri }}" autocomplete="off" type="text" name="uri" class="form-control" required>
                                        <label for="uri" class="form-label">Uri *</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input id="title" value="{{ $page->title }}" autocomplete="off" type="text" name="title" class="form-control">
                                        <label for="title" class="form-label">Title</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <textarea id="excerpt" name="excerpt" rows="5" class="form-control no-resize">{{ $page->excerpt }}</textarea>
                                        <label for="excerpt" class="form-label">Excerpt</label>
                                    </div>
                                </div>

                                <div class="form-group form-float">
                                    <input @if ($page->active) checked @endif name="active" type="checkbox" id="active_checkbox" class="filled-in chk-col-purple" />
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <select name="pid" id="pid" class="form-control show-tick">
                                        ...
                                        <option @if ($page->pid == 1) selected @endif value="1">/</option>
                                        <option @if ($page->pid == 2) selected @endif value="2">Login</option>
                                        <option @if ($page->pid == 3) selected @endif value="3">Register</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <select id="template" name="template" class="form-control show-tick" required>
                                        <option value="">-- Select --</option>
                                        <option @if ($page->template == 1) selected @endif value="1">blank</option>
                                        <option @if ($page->template == 2) selected @endif value="2">blog</option>
                                        <option @if ($page->template == 3) selected @endif value="3">news</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group form-float">
                                    <input @if ($page->in_menu) checked @endif name="in_menu" type="checkbox" id="in_menu_checkbox" class="filled-in chk-col-purple" />
